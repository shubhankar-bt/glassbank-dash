  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        glass: "glass-button text-foreground hover:shadow-button hover:scale-105",
        "glass-primary": "glass-button bg-primary/20 text-primary-foreground border-primary/30 hover:bg-primary/30 hover:border-primary/50 shadow-button",
        hero: "bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:shadow-button hover:scale-105 font-semibold",
      },
      size: {
